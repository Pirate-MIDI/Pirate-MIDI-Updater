...
function DiagnosticImageModal({ show, onClose, onAccept }) {
    return (
                        ...
                        <Transition.Child
                            ...
                            <Dialog.Panel className="w-full max-w-xl p-4 overflow-hidden text-left align-middle transition-all transform bg-white rounded-lg shadow-xl text-slate-800">
                                ...
                                <p className="pb-4 mt-4 text-sm font-bold text-center border-b">
                                    This binary is a diagnostic image!
                                </p>
                                <p className='mt-4 text-sm text-center'>
                                    This is a diagnostic image and not intended for public use. Only install this image after explicit direction from Pirate MIDI.
                                    Proceeding with this without prior recommendation from Pirate MIDI may void your warranty
                                </p>
...
export default DiagnosticImageModal