...
function InstallBar({ device, release }) {
    ...
    return (
        <div className="flex items-center justify-end p-4 h-1/6">
            <button disabled className={`flex items-center px-4 py-2 m-4 font-bold border rounded hover:text-slate-800 ${stylePrerelease(release)}`}>
